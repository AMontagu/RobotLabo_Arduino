...
public:
	...
	int melodyrandomNumber = 52;
	int melodyrandom[52] = {NOTE_A3, NOTE_B3, NOTE_C4, NOTE_D4,NOTE_E4,NOTE_D4,NOTE_C4,NOTE_B3,NOTE_C4,NOTE_D4,NOTE_E4,NOTE_D4,NOTE_C4,NOTE_D4,NOTE_E4,NOTE_D4,NOTE_C4,NOTE_B3,NOTE_C4,NOTE_B3,NOTE_A3,NOTE_B3,NOTE_G3,NOTE_A3,0,NOTE_A3,NOTE_B3,NOTE_C4,NOTE_B3,NOTE_C4,NOTE_D4,NOTE_C4,NOTE_D4, NOTE_E4,NOTE_D4,NOTE_C4,NOTE_A3,NOTE_A3,NOTE_B3,NOTE_C4,NOTE_D4,NOTE_E4,NOTE_F4,NOTE_A3,NOTE_D4,NOTE_C4,NOTE_D4,NOTE_B3,NOTE_A3,NOTE_C4,NOTE_B3,NOTE_A3};
	int noteDurationmelodyrandom[52]= {2,2,3,1,2,2,2,2,2,2,2,4,1,1,3,1,2,2,2,2,3,1,2,2,8,1,1,3,1,2,2,2,2,3,1,2,4,1,1,2,2,2,2,2,2,3,1,2,4,1,1,6 };
