...
class Sound : public Actioner
{
 private:
	...
	int melodyMario[80] = {NOTE_E7, NOTE_E7, 0, NOTE_E7,0, NOTE_C7, NOTE_E7, 0,NOTE_G7, 0, 0,  0,NOTE_G6, 0, 0, 0,NOTE_C7, 0, 0, NOTE_G6,0, 0, NOTE_E6, 0,0, NOTE_A6, 0, NOTE_B6,0, NOTE_AS6, NOTE_A6, 0,NOTE_G6, NOTE_E7, NOTE_G7,NOTE_A7, 0, NOTE_F7, NOTE_G7,
	...
	int noteDurations2[80] = {12, 12, 12, 12,12, 12, 12, 12,12, 12, 12, 12,12, 12, 12, 12,12, 12, 12, 12,12, 12, 12, 12,12, 12, 12, 12,12, 12, 12, 12,
	 ...
	 //Underworld melody
	 int melodyUnderworld[50] = {NOTE_C4, NOTE_C5, NOTE_A3, NOTE_A4,NOTE_AS3, NOTE_AS4, 0,0};
	 int underworld_tempo[50] = {12, 12, 12, 12,12, 12, 6,3};

	 //Underworld melody2
	 int melodyUnderworld2[50] = {0, NOTE_DS4, NOTE_CS4, NOTE_D4,NOTE_CS4, NOTE_DS4,NOTE_DS4, NOTE_GS3,NOTE_G3, NOTE_CS4,NOTE_C4, NOTE_FS4, NOTE_F4, NOTE_E3, NOTE_AS4, NOTE_A4,NOTE_GS4, NOTE_DS4, NOTE_B3,NOTE_AS3, NOTE_A3, NOTE_GS3,0, 0, 0};
	 int underworld_tempo2[50] = {6, 18, 18, 18,6, 6,6, 6,6, 6,18, 18, 18, 18, 18, 18,10, 10, 10,10, 10, 10,3, 3, 3};
