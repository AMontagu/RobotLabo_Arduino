...
void Sound::doAction(int actionNumber) {
	...
	case 4:
		...
		break;
	case 5:
		noteNumber = this->musiqueTelephone;
		melodyTab = new int[noteNumber];
		memcpy(melodyTab, this->melodyTelephone, noteNumber * sizeof(int));
		notesDurations = new int[noteNumber];
		memcpy(notesDurations, this->noteDurationsTelephone, noteNumber * sizeof(int));
		break;
	case 6:
		noteNumber = this->musiqueImprimente;
		melodyTab = new int[noteNumber];
		memcpy(melodyTab, this->melodyImprimente, noteNumber * sizeof(int));
		notesDurations = new int[noteNumber];
		memcpy(notesDurations, this->noteDurationsUnderworld, noteNumber * sizeof(int));
		break;
